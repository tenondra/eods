...
private ["_jugador","_antena","_mochila","_encontroCadena","_mochilaV2","_buscarMochila","_azar","_tiempo","_titulo","_mochilaFake","_pos","_dist","_offdir","_compassDir","_newX","_newY","_newPos"];

_jugador = _this select 0;

_antena = (_this select 3) select 1;
...
if ((EODS_IEDS_PCU_CHECK_ACCION_RESULTADO) && (!EODS_IEDS_PCU_CHECK_ACCION_INTERRUMPIDA)) then {
	...
	if (_encontroCadena) then {
		...
		switch (_antena) do {
	   		...
	   		case "EODS_Inv_LowBandAntenna": {_mochilaV2 = "EODS_THORIII_LOW_UCP";};

	   		case "EODS_Inv_MidBandAntenna": {_mochilaV2 = "EODS_THORIII_MID_UCP";};

	   		case "EODS_Inv_HighBandAntenna": {_mochilaV2 = "EODS_THORIII_HIGH_UCP";};
		};
		...
		switch (_antena) do {
			...
			case "EODS_Inv_LowBandAntenna": {_mochilaV2 = "EODS_THORIII_LOW_OCP";};

	   		case "EODS_Inv_MidBandAntenna": {_mochilaV2 = "EODS_THORIII_MID_OCP";};

	   		case "EODS_Inv_HighBandAntenna": {_mochilaV2 = "EODS_THORIII_HIGH_OCP";};
		};
	};
	...
	_jugador unassignItem _antena;

	_jugador removeItem _antena;
